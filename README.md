...
```sh
curl -fsSL https://raw.githubusercontent.com/bgarcevic/ripbi/main/install.sh | RIPBI_VERSION=v0.2.2 sh
```

```powershell
$env:RIPBI_VERSION = 'v0.2.2'; irm https://raw.githubusercontent.com/bgarcevic/ripbi/main/install.ps1 | iex
```
